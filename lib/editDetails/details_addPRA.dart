...
class detailsPRA extends StatefulWidget {
  Map patientMap;
  detailsPRA(this.patientMap);

  @override
  State<detailsPRA> createState() => _detailsPRAState();
}

class _detailsPRAState extends State<detailsPRA> {
            ...
            children: [
              ...
              ElevatedButton(
                  onPressed: () async {
                    ...
                    try {
                      if (PRAcontrol.text != "") {
                        data_class.updateDataPRA(keyGot, PRAcontrol.text);
                        Navigator.of(context).pop();
                        Fluttertoast.showToast(msg: "Update Successful");
                      } else {
                        Fluttertoast.showToast(
                            msg: 'Please Add Correct PRA Value');
                      }
                    } catch (e) {
                      // TODO
                      Fluttertoast.showToast(
